...
import java.util.List;
 ...
 public class DataController
 {
   ...
   @GetMapping({"/filter"})
   @CrossOrigin
   public List<Map<String, Object>> getAttributes(@RequestHeader("Authorisation") String authorisation) throws JCoException {
   ...
   @CrossOrigin
   public ReportDTO getFilteredData(@RequestHeader("Authorisation") String authorisation, @RequestBody FilterData data) throws JCoException {
     JwtUser user = this.jwtValidator.validate(authorisation);
   ...
   @CrossOrigin
   public Map<String,ReportDTO> getFilteredDataMultiple(@RequestHeader("Authorisation") String authorisation, @RequestBody FilterData data) throws JCoException {
     JwtUser user = this.jwtValidator.validate(authorisation);
